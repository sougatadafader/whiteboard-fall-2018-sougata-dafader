...
const HeadingWidget = ({updateWidget,widget}) =>
    <div className="heading-widget">
        <div className="form-group row">
            <label className="col-sm-2 col-form-label">Heading Text</label>
            <div className="col-sm-10">
                <input className="form-control" placeholder="Some Heading" id={widget.id+'-heading'} required="" defaultValue={widget.text} onChange={()=>updateWidget(widget)}/>
            </div>
        </div>
        <div className="form-group row">
            <label className="col-sm-2 col-form-label">Heading Size</label>
            <div className="col-sm-10">
                <select className="form-control" required="" id={widget.id+'-size'} defaultValue={widget.size} onChange={()=>updateWidget(widget)}>
